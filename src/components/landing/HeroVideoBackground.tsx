...
export default function HeroVideoBackground() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full z-0 overflow-hidden bg-[#000000]">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[400px] bg-gradient-to-t from-[#000000] via-[#000000]/80 to-transparent pointer-events-none" />
      {/* Left/Right fades to eliminate any edge cutoffs */}
      <div className="absolute inset-y-0 left-0 w-[15vw] bg-gradient-to-r from-[#000000] to-transparent pointer-events-none" />
      <div className="absolute inset-y-0 right-0 w-[15vw] bg-gradient-to-l from-[#000000] to-transparent pointer-events-none" />
    </div>
  );
}
